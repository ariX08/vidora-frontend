...
export const normalizeMediaUrl = normalizeYouTubeUrl;
...
export const isValidMediaUrl = isValidYouTubeUrl;
...
export function isYouTubeUrl(url: string): boolean {
  return /youtube\.com|youtu\.be/i.test(normalizeYouTubeUrl(url));
}
